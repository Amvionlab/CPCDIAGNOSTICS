...
const blogs = [
  //this is first blog
  {
    ...
    date: "May 31, 2024",
    image: blog1,
    slug: 'hematology-analyzer-working-principle-uses-price',
  ...
  //this is second blog
  {
    ...
    date: "May 25, 2024",
    image: blog2,
    slug: 'difference-between-3-part-and-5-part-hematology-analyzer',
    ...
    sections: [
      ...
      },
      {
        ...
        content4:
          "Dynacount 5D is a 5-part hematology analyzer from Everlife CPC that can analyze up to 60 samples per hour. It uses four scattergrams and two histograms to derive 28 parameters + 8 research parameters. It employs laser scatter flow cytometry to differentiate all types of WBCs with high precision. It also includes a robust system that manages and assures the quality of the data.",
  ...
  //this is third blog
  {
    ...
    date: "Feb 27, 2024",
    image: blog3,
    slug: 'biochemistry-analyzer-working-principle-uses-price',
  ...
  //this is fourth blog
  {
    ...
    date: " Jul 6, 2023",
    image: blog4,
    slug: 'what-a-hemo-globin-is-and-common-types-of-blood-disorder',
    content: "Full content of the third blog...",
    sections: [
      {
        startcontent:
  ...
  //this is fifth blog
  {
    ...
    date: "Jul 6, 2023",
    image: blog5,
    slug: 'an-introduction-to-a-fully-automated-immunoassay-analyzer',
    content: "Full content of the third blog...",
    sections: [
      {
        startcontent:
  ...
  //this is sixth blog
  {
    ...
    date: "Jul 6, 2023",
    image: blog6,
    slug: 'how-to-ensure-effective-result-in-haematology-analyzers',
    content: "Full content of the third blog...",
    sections: [
      {
        startcontent:
  ...
  //this is seventh blog
  {
    ...
    date: "Feb 13, 2023",
    image: blog7,
    slug: 'basics-of-3-part-hematology-analyzer',
    content: "Full content of the first blog...",
    sections: [
      {
  ...
  //this is ninth blog
  {
    ...
    date: "Dec 8, 2022",
    image: blog9,
    slug: 'allergies-causes-symptoms',
    content: "Full content of the first blog...",
    sections: [
      {
        startcontent:
  ...
  //this is tenth blog
  {
    ...
    date: "Dec 6, 2022",
    image: blog10,
    slug: 'novel-treatment-for-lethal-diseases',
    content: "Full content of the first blog...",
    sections: [
      {
        startcontent:
  ...
  //this is twelvth blog
  {
    ...
    date: "Oct 12, 2022",
    image: blog12,
    slug: 'rheumatoid-factor-introduction',
    content: "Full content of the first blog...",
    sections: [
      {
        startcontent:
  ...
  //this is Fourteenth blog
  {
    ...
    date: "Aug 31, 2022",
    image: blog14,
    slug: 'cardiac-biomarkers-heart-attack',
    content: "Full content of the first blog...",
    sections: [
      {
        startcontent:
  ...
  //this is Sixteenth blog
  {
    ...
    date: "Jun 20, 2022",
    image: blog16,
    slug: 'hyperlipidemia-atherosclerosis',
    content: "Full content of the first blog...",
    sections: [
      {
        title: "Overview",
  ...
  //this is seventeenth blog
  {
    ...
    date: "May 9, 2022",
    image: blog17,
    slug: 'anti-phospholipid-syndrome',
    content: "Full content of the first blog...",
    sections: [
      {
  ...
  //this is Eighteenth blog
  {
    ...
    date: "May 9, 2022",
    image: blog18,
    slug: 'systemic-sclerosis-disease',
    content: "Full content of the first blog...",
    sections: [
      {
