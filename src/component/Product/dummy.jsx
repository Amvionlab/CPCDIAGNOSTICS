                ...
                <div className="grid grid-cols-2 laptop:grid-cols-4 justify-around">
                  {headingSection.map((sectionCategoryItem, i) => (
                    <p
                      ...
                      className={` text-xs tablet:text-lg capitalize font-medium cursor-pointer mb-2 ${section ===
                        sectionCategoryItem.split(" ").join("").toLowerCase()
                        ? "font-extrabold text-[#00A786]"
                        : ""
                        }`}
                    >
                      {sectionCategoryItem}
                  ...
                  {final.map((item) => (
                    ...
                    >
                      <div className="bg-white border rounded-lg overflow-hidden relative group h-[200px] tablet:h-[300px]">
                        ...
                        <div className="hidden absolute inset-0 bg-maincol/80 justify-center items-center text-white text-xl group-hover:flex">
                          View Product
                        </div>
                      </div>
                    </Link>
