...
function ProductSub() {
    ...
    const selectedCategoryItems = data
        ? data.find((categoryURL) => categoryURL.categoryURL === selectedCategory)?.items ||
        []
        : [];
    const headingSection = data
        ? data.find((categoryURL) => categoryURL.categoryURL === selectedCategory)
            ?.subsection || []
        : [];
    ...
    const description =
        data
            ?.find((categoryURL) => categoryURL.categoryURL === selectedCategory)
    ...
    const handleNavigation = (categoryURL, section) => {
        console.log(categoryURL, section);
    ...
    setSelectSectionCategory(section);
    ...
    useEffect(() => {
        // Find the matching category name based on URL
        const matched = categories.find(
            (cat) => cat.categoryURL === selectedCategory
        );
                ...
                <>
                        ...
                        <section className=" productSection largeLaptop:text-2xl py-2 text-base text-gray-700 laptop:mb-14">
                            <div className="mb-3">
                                <p>
                                    ...
                                    <span> / </span>
                                    <span className="font-semibold">{categoryToShow || "None Selected"}</span>
                                </p>
                            </div>
                            <div
                                className="flex items-center gap-2 text-xl justify-start sm:hidden"
                                        ...
                                        {headingSection.map((sectionCategoryItem, i) => (
                                            <p
                                                ...
                                                className={`${selecteSectionCategory ===
                                                    ...
                                                    : "font-medium"
                                                    } text-xs w-fit hover:text-[#00A786] transition-all ease-in duration-75 hover:font-bold tablet:text-sm largeLaptop:text-lg capitalize text-left text-nowrap cursor-pointer mb-2`}
                                            >
                                                {sectionCategoryItem}
                                            </p>
                                        ))}
                  ...
                  <p className="text-sm tablet:text-lg mb-2 tablet:text-left">
                    {description}
                                    ...
                                    {/* <p className="px-4 py-2 bg-maincol text-left w-fit text-white rounded-md">
              Read More
            </p> */}
                                    {/* </div> */}
