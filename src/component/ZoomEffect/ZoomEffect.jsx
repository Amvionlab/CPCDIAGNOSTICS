    ...
    <div>
      <div className="flex flex-col gap-2   w-full h-full mb-5 tablet:mb-0">
        ...
        <div className="flex justify-center items-center flex-col gap-3  tablet:mt-5 font-poppins">
          ...
          <p className="tablet:text-lg text-center largeLaptop:text-lg mt-4">
            CPC developed i-track, a proprietary system for remote instrument
            maintenance, in a groundbreaking initiative.
          </p>
          <p className="tablet:text-lg text-center laptop:mb-10">
            For Support Dial:{" "}
            <span className="text-[#00A786] largeLaptop:text-lg">
              <a href="tel:1800 571 1101">1800 571 1101</a>
            </span>
          </p>
        </div>
        ...
        >
          ...
          <div className="flex justify-evenly items-center">
            {/* <img
              ...
              src={pictures[4].src}
              loading="lazy"
              alt={pictures[4].alt} For Support Dial
            /> */}
            <iframe
              className=" w-full h-[25vh] tablet:w-[500px] tablet:h-[270px] laptop:w-[800px] laptop:h-[470px] rounded-lg"
