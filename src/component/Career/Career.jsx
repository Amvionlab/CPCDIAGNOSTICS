...
<button type="submit" className='bg-cpccol text-fontptag text-white px-6 py-2 rounded-r-md hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ml-1' onClick={handleButtonClick}>Apply Here</button>
        ...
        <div className='tablet:container container-fluid mx-auto'>
        ...
        <div className='bg-shade p-2 mt-5 container-fluid mx-auto'>
          ...
          <main className='bg-white rounded-lg' id='openings'>
            <div className='md:flex lg:flex xl:flex md:gap-10 lg:gap-10 xl:gap-10 p-3'>
              <div className='mt-8'>
                <h4 className='text-[17px]'>Refine By</h4>
            ...
            />
                ...
                <div className='mt-4'>
                  ...
                  <select
                    ...
                    className="border-2 p-2 lg:w-56 xl:w-56 md:w-56 mt-4 text-sm"
                  >
              ...
              <div className='mt-2 '>
                ...
                <div className='flex justify-center'>
                  ...
                  <div className="relative w-3/4">
                    <label htmlFor="searchInput" className="absolute -top-5 left-0 text-sm text-gray-600">
                    ...
                    <input
                      ...
                      className="border w-full bg-[#B2BEB5] text-[#000] p-2 rounded-md"
                    />
                  </div>
                  <button
                    onClick={filterJobs}
                    className="border p-2 bg-cpccol text-white ml-2 text-[14px]"
                  >
                    Search
                  </button>
                  <button
                    ...
                    className="border p-2 ml-2 text-[14px]"
                  >
                    Reset
                  </button>
                </div>
                ...
                <div className=" grid laptop:grid-cols-3 grid-cols-1 tablet:grid-cols-2 gap-10 mt-4 tablet:ml-8 ">
                    ...
                    <div key={index} className="group p-6 bg-shade rounded-lg leading-8 shadow-md hover:shadow-lg  ">
                      ...
                      <div className='flex flex-col-reverse items-center largeLaptop:flex-row justify-between gap-4'>
                        <div className='flex   flex-col items-center'>
                          ...
                          <button
                            type="button"
                            className="bg-slate-50 align-center  text-center shadow-sm rounded-md hover:shadow-md transition-all ease-in-out p-1 w-28 mt-4 group-hover:bg-cpccol group-hover:text-white text-[15px]"
