  ...
  useEffect(() => {
    switch (location.pathname) {
      ...
      case "/about-us":
        ...
        break;
      case "/corporate-social-responsibility-csr-policy":
        setSelected("corporate-social-responsibility-csr-policy");
        break;
      case "/our-brands":
        setSelected("our-brands");
        break;
      case "/career":
        setSelected("career");
        break;
  ...
  return (
    <div className="md:flex sticky p-2  bg-white border-b border-b-custom-green top-0 whitespace-nowrap h-fit w-full z-50 items-center justify-around shadow-md overflow-visible">
              ...
              <div className="text-base font-lato ">
                ...
                <li>
                  <Link
                    ...
                    to="/corporate-social-responsibility-csr-policy"
                  >
                    CSR Policy
                  </Link>
                </li>
      ...
      >
        ...
        >
          ...
          {showDropdown.about && (
            <div className="dropdown-menu w-fit mt-0">
              ...
              <Link className="dropdown-item" to="/corporate-social-responsibility-csr-policy">
                CSR Policy
              </Link>
            </div>
          )}
        ...
        <div className="nav-item">
          <Link
            className={`cursor-pointer ${selected === "our-brands" ? "selected" : ""
              }`}
            to="/our-brands/"
          >
            Our Brands
        ...
        <div className="nav-item">
          <Link
            className={`cursor-pointer ${selected === "our-success" ? "selected" : ""
              }`}
            to="/our-success"
          >
            Our Success
        ...
        <div className="nav-item">
          <Link
            className={`cursor-pointer ${selected === "contact-us" ? "selected" : ""
              }`}
            to="/contact-us"
          >
            Contact
