...
const About = () => {
  ...
  const images = [image2, image4, image5, image6, image8];
  const settings = {
    slidesToShow: 4,
    autoplaySpeed: 2500,
  };
        ...
        <div className="scroll-smooth ">
            ...
            <header className="md:absolute w-full h-full md:left-0 md:top-0 md:ml-20 md:text-white mx-0 p-10">
              <div className="max-w-[1300px] h-full mx-auto flex flex-col justify-center">
                ...
                <p className="mt-2 text-fontforptag md:text-left text-left">
                  We are a leading Medical Laboratory
                </p>
                <p className="mt-2 text-fontforptag md:text-left text-left">
                  Equipment
                  Manufacturer
          ...
          <div className="flex md:flex-row flex-col md:mt-10 sm:mt-28 max-w-[1300px] mx-auto">
            ...
            <div className="md:w-1/2 p-4">
              <button className="bg-[#00A786] text-white p-2 rounded-lg font-semibold shadow-custom-shadow mt-4">
                since-1987
              </button>
              <h2 className="md:text-2xl lg:text-2xl xl:text-2xl text-xl mt-4 font-medium leading-normal text-[#00A786] text-left">
                {text.map((el, i) => (
                  <motion.span
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
              ...
              <div className="p-4 ">
                <div className="flex items-start  text-justify leading-7">
                  <SiTicktick size={20} color="#00A786" className="mr-4" />
              ...
              <div className="p-4 ">
                ...
                <p className="text-fontforptag md:pl-12 mt-2 text-justify">
                  Operating in 3 countries with over 300 employees, we serve more
                  than 1000+ customers, ensuring timely and efficient
              ...
              <div className="p-4 ">
                ...
                <p className="text-fontforptag md:pl-12 mt-2 text-justify">
                  Our extensive network of 500+ channel partners in India enables us
          ...
          <div className="grid md:grid-cols-12 grid-cols-12  gap-2  p-20 animate-fade-up delay-100 max-w-[1300px] mx-auto relative">
            ...
            <div className="md:col-span-12 col-span-12 md:text-center z-20 ">
              ...
              <br />
              <p className="text-fontforptag md:pl-40 md:pr-40 sm:pl-0 sm:pr-0 text-justify">
            ...
            <div className="md:col-span-6 col-span-12  bg-white text-black p-4 mt-4 z-20 shadow-custom-shadow leading-6 text-center">
              <div className=" md:p-10 sm:p-10 ">
                <div className="text-center">
                  <div className="flex justify-center">
                    <FaGlobeAsia size={40} color="#00A786" className="mr-4" />
                  </div>
                  <h3 className="font-bold text-lg mt-2 text-left text-maincol text-center">
                    Our Vision
                  </h3>
                </div>
                <p className="text-fontforptag">
            ...
            <div className="md:col-span-6 col-span-12 bg-white text-black p-4 mt-4 md:z-20 shadow-custom-shadow">
              <div className=" md:p-10 sm:p-10 text-center">
                <div className="flex justify-center">
                  <TbTargetArrow size={40} color="#00A786" className="mr-4" />
                </div>
                <h3 className="font-bold text-lg text-left mt-2 text-maincol text-center">
                  Our Mission
                </h3>
                <p className="text-fontforptag">
          ...
          <div>
            <h3 className="text-maincol font-semibold md:text-3xl text-2xl text-center">
              Our Core Values
            </h3>
            <div className="grid md:grid-cols-12 sm:grid-cols-2  gap-2 animate-fade-up delay-200 max-w-[1300px] mx-auto">

              <div className="col-span-6 p-4 w-full flex items-center justify-center ">

                <img src={ourvalue} alt="our core value" className="w-[100%] h-auto rounded-lg" />
              </div>

              <div className="col-span-6 p-4 mt-3">
                ...
                <p className="ml-2 mt-6 text-justify text-md text-fontforptag">
                  ...
                  day. By embodying these principals, we strive to foster a culture
