    ...
    <>
      ...
      <div className="hidden h-[300vh] tablet:flex font-poppins mb-20" id="mm">
        ...
        <div className="w-[50vw] flex justify-end items-center font-poppins pr-10">
          ...
          >
            <div className="flex gap-2 text-sm tablet:text-2xl text-[#00A786]">
            ...
            <div
              ...
              className="w-[2px] h-[20vh] bg-maincol relative -top-[20vh] left-[3vh]"
            ></div>
          </div>
          {/* Content 2 */}
          <div
          ...
          >
            <div className="flex gap-2 text-2xl text-[#00A786]">
              <p
            ...
            <div
              ...
              className="w-[2px] h-[18vh] bg-maincol relative -top-[15vh] left-[3vh]"
            ></div>
          </div>
          {/* Content 3 */}
          <div
          ...
          >
            <div className="flex gap-2 text-2xl text-[#00A786] items-center">
              <p
