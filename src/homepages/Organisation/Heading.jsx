...
function Heading() {
  ...
  return (
    <div
     ...
     gap-4"
    >
      {/* <p className="text-lg tablet:text-3xl largeLaptop:text-4xl text-[#00A786] font-semibold title1 uppercase">
        Sachika
      </p> */}
      <div className="">
        <img
          src={sachika}
          alt="img"
          className="w-[280px] tablet:w-[320px]  object-contain rounded-lg"
        />
      </div>
      {/* <p
